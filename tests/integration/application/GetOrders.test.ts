...
test('should be able to list all orders', async () => {
  ...
  orderOne.addItem(new Item(1, "Guitarra", 1000, new Dimension(100, 30, 10), 3), 1)

  const orderTwo = new Order("44976087867", new Date('2022-05-17T13:00:00.000'));
  orderTwo.addItem(new Item(1, "Guitarra", 1000, new Dimension(100, 30, 10), 3), 5)

  const orderThree = new Order("44976087867", new Date('2022-05-17T13:00:00.000'));
  orderThree.addItem(new Item(1, "Guitarra", 1000, new Dimension(100, 30, 10), 3), 10)
